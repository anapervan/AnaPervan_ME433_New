...
char WaveformA[NUMSAMPS], WaveformB[NUMSAMPS]; // global variables

void initSPI1();
void SPI1_IO(unsigned char);
void makeWaveformA();
void makeWaveformB();
...
void initSPI1() {
  ...
  RPA1Rbits.RPA1R = 0b0011;     // SDO pin
  SDI1Rbits.SDI1R = 0b0100;     // SDI pin
  SS1Rbits.SS1R = 0b0000;       // SS1 on A0
}
