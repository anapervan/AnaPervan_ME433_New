...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    //int Blue = 200; // for blue threshold
...
//            for (int startY = 0; startY < bmp.getHeight(); startY++) {
            for (int startY = 100; startY < 175; startY+=10) { // coarse, but maybe ok
                ...
                */
                ...
                for (int i = 0; i < bmp.getWidth(); i++) {
                    if (((green(pixels[i]) - red(pixels[i])) > -Gray)&&((green(pixels[i]) - red(pixels[i])) < Gray)&&(green(pixels[i])  > Brightness)&&(blue(pixels[i]) < 175) ) {
...
//        canvas.drawText("pos = " + pos, 10, 200, paint1);
        ...
        mTextView.setText("FPS: " + String.valueOf(1000 / diff) + ", Gray: " + String.valueOf(Gray) + ", Brightness: " + String.valueOf(Brightness) + ", COM: " + String.valueOf(COM));
        prevtime = nowtime;
    }
